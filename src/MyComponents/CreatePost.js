  ...
  var aDay = 24*60*60*1000;
    ...
    return (
        ...
        <div className="make_post">
           ...
           <div className="make_post_head">Please describe your request</div>
            <form action="">
                ...
                <div className="quote_main">"Stop judging and start helping"</div>
                <div className="quote_author">--Anonymous</div>
                </div>
            </form>            
        </div>
    )
